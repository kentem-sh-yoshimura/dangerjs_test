...
schedule(async () => {
  ...
  message(beforeDependencies ?? 'beforeDependencies')
  message(afterDependencies ?? 'afterDependencies')
  message(beforeDevDependencies ?? 'beforeDevDependencies')
  message(afterDevDependencies ?? 'afterDevDependencies')
